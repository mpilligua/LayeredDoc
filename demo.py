...
parser.add_argument('--result_dir', default='/ghome/mpilligua/DocumentConversion/Results_paper/Inferencia/Restormer-3Ch/NewTest_6000', type=str, help='Directory for restored results')
...
parser.add_argument('--ckpt_dir', required=False, type=str, default='/ghome/mpilligua/DocumentConversion/Denoise/Restormer/experiments/ResTormer_3CHANNELS/models/net_g_6000.pth', help='Directory of the model checkpoint')
...
load_arch = run_path(os.path.join('basicsr', 'models', 'archs', 'restormer_norm_arch.py'))
